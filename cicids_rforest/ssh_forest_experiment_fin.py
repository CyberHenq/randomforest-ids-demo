...
label_groups = ['Normaali', 'SSH-Patator']
label_map = {'BENIGN' : 'Normaali',
...
def feature_selection(x_train, x_validate, x_test, y_train, dataset):
    ...
    ax.set_ylabel('Ominaisuuden pisteytys')
    ax.set_title('Ominaisuuksien vertailu')
    ax.set_xticks(x)
    ...
    plt.xlabel('Ominaisuus', fontsize=8)
    plt.ylabel('Ominaisuuden pisteytys', fontsize=8)
    plt.title('Ominaisuuksien kumulatiivinen pisteytys', fontsize=8)
    plt.tight_layout()
    fig.set_figwidth(15)
    fig.set_figheight(5)
...
def optimize_model(x_train, x_validate, y_train, y_validate, features_count):
    ...
    plt.xlabel('Puiden määrä')
    plt.ylabel('Luokittelun kesto (s)')
    plt.title('Puiden määrän vaikutus luokittelun kestoon')
    ...
    plt.xlabel('Puiden määrä')
    plt.ylabel('F1-arvo')
    plt.title('Puiden määrän vaikutus F1-arvoon validointiaineistolla')
...
def optimized_random_forest(x_train, x_test, y_train, y_test):
    ...
    plt.title('Tulosten ristiintaulukointi')
